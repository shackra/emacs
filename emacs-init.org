  ...
  (defun shackra:appt-muestra-notificacion (min-to-app new-time msg)
    (if (atom min-to-app)
        ...
        (notifications-notify
         :title "Aviso de la agenda"
         :body (format "<b>Cita en %d minuto(s):</b><br>%s<br>" min-to-app msg)
         :appname "emacs"
      ...
      (dolist (i (number-sequence 0 (1- (length min-to-app))))
        (notifications-notify
         :title "Aviso de la agenda"
         :body (format "<b>Cita en %d minuto(s):</b><br>%s<br>" (nth i min-to-app) (nth i msg))
         :appname "emacs"
         :app-icon "/usr/share/icons/Adwaita/32x32/status/appointment-soon.png"
         :urgency "critical"
         :sound-file "/usr/share/sounds/freedesktop/stereo/alarm-clock-elapsed.oga"
