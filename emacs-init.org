...
#+BEGIN_SRC emacs-lisp
  (define-key eyebrowse-mode-map (kbd "z") 'eyebrowse-prev-window-config)
  (define-key eyebrowse-mode-map (kbd "x") 'eyebrowse-next-window-config)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (setf notify-method 'notify-via-dbus)
#+END_SRC
