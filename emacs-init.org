...
#+BEGIN_SRC emacs-lisp
  ;;(diminish 'yas/minor-mode) ;; diminish: yas/minor-mode is not currently registered as a minor mode
   ...
   2. Org-mode
     ...
     #+begin_src emacs-lisp
       ...
       (setf org-todo-keywords
             '((sequence "POR HACER(p)" "EN PROGRESO(g)" "EN ESPERA(e@/!)" "EN REVISIÓN(r@/!)" "|" "TERMINADO(t!)" "CANCELADO(c@)")))
