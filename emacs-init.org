  ...
  if os.path.isdir(os.path.expanduser("~/.emacs.d/elpa/")):
      ...
      for package in melpapackages:
          if os.path.isdir(os.path.expanduser("~/.emacs.d/elpa/") + package):
              ...
              if not name == "archives-" and not name == "archives" and not name == "gnupg-":
...
#+BEGIN_SRC emacs-lisp
  (defun shackra:org-html-wrap-blocks-in-code (src backend info)
    "Encierra bloques de código entre <pre><code class=\"lang\">.</code></pre>"
...
castellanizar los enlaces y sus títulos en el blog.
      ...
      #+BEGIN_SRC emacs-lisp
        ...
        (add-to-list 'org-export-filter-src-block-functions
                     'shackra:org-html-wrap-blocks-in-code)
      #+END_SRC
