...
(ignore-errors (use-package muse
  :ensure muse))
(ignore-errors (use-package mustache
  :ensure mustache))
(ignore-errors (use-package nav-flash
  :ensure nav-flash))
...
(ignore-errors (use-package parent-mode
  :ensure parent-mode))
(ignore-errors (use-package pcache
  :ensure pcache))
...
(ignore-errors (use-package web-beautify
  :ensure web-beautify))
