...
(setf package-selected-packages '(ace-window ag aggressive-indent alert all-the-icons android-mode auctex aurel auto-yasnippet better-defaults blacken bookmark+ bug-hunter cargo cask-mode chronos commander company company-auctex company-childframe company-emoji company-go company-lsp company-quickhelp company-statistics company-tern counsel counsel-notmuch counsel-projectile dash dired-details+ docker docker-compose-mode dockerfile-mode el-pocket el2org elfeed emmet-mode emojify epl expand-region f feature-mode fixmee flycheck-cask flycheck-gometalinter flycheck-kotlin flycheck-package flyspell-correct-ivy font-lock-studio free-keys gimp-mode git git-gutter-fringe gitconfig-mode gitignore-mode go-eldoc go-guru go-mode go-snippets godoctor golden-ratio golden-ratio-scroll-screen gradle-mode hgignore-mode highlight-escape-sequences highlight-indent-guides highlight-numbers hungry-delete iedit imenu-anywhere importmagic indium ivy-hydra js2-refactor json-mode keyfreq kill-or-bury-alive kotlin kotlin-mode langtool lsp-css lsp-html lsp-javascript-typescript lsp-php lsp-python lsp-rust lsp-ui lsp-vue magit-gh-pulls magit-todos meghanada mingus monky monokai-theme move-text moz-controller mu4e-alert multi-term multiple-cursors mustache-mode ng2-mode nlinum noflet notmuch-labeler omnisharp org-beautify-theme org-bullets org-download org-plus-contrib org-projectile org-redmine org-trello org-webpage org2web ox-gfm package-build paredit pcre2el pdf-tools php-mode php-refactor-mode pippel pkgbuild-mode pony-mode pretty-mode prodigy projectile py-autopep8 pydoc-info python-environment pyvenv rainbow-mode ranger realgud rjsx-mode s scss-mode shackle shut-up slack slime sphinx-doc stylus-mode switch-buffer-functions sx systemd telephone-line tern toml-mode traad twittering-mode undo-tree use-package vimish-fold virtualenvwrapper visual-fill-column vlf vue-mode web-beautify web-mode webpaste weechat windresize ws-butler xref-js2 yaml-mode yasnippet zenburn-theme))
