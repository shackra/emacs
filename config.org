...
(custom-set-faces!
  '(mode-line :family "Fira Code" :height 0.8)
...
(when (and (featurep! :completion company)
  ...
  (add-hook! 'company-mode-hook #'company-mode-update-backends-with-yasnippet))

(after! yasnippet
  (defun shackra-yas-reload ()
    "Recarga las definiciones de YaSnippet una vez"
    (yas-reload-all)
    (remove-hook 'yas-minor-mode-hook #'shackra-yas-reload))

  (add-to-list 'yas-snippet-dirs (expand-file-name "plantillas" doom-private-dir) nil)

  (add-hook! 'yas-minor-mode-hook #'shackra-yas-reload))
#+end_src
* Golang
