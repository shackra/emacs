...
(after! web-mode
  ...
  (defvar prettier-compatible-hooks '(typescript-mode-hook js-mode-hook json-mode-hook css-mode-hook html-mode-hook yaml-mode-hook)
...
Ajustes menores
#+begin_src emacs-lisp
(when (and (featurep! :ui workspaces) nil)
