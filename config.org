...
He tomado algunas previsiones en caso de que algún día decida arrancar Emacs desde la terminal.
#+begin_src emacs-lisp
(when (and (eq system-type 'darwin)
           (eq default-directory "/")
           (display-graphic-p))
...
(after! org-capture
  ...
  (add-to-list 'org-capture-templates `("T" "Anotacion técnica" entry (file "apuntes tecnicos.org")
...
(when (and (featurep! :completion company)
  ...
  (defun shackra-use-company-capf-with-yasnippet ()
    (setq company-backends (list 'company-capf :with 'company-yasnippet)))
...
#+begin_src emacs-lisp
(set-formatter! 'prettier-with-npx
  '("npx" "prettier" "--stdin-filepath" (or buffer-file-name mode-result ""))
  :modes '(js-mode typescript-mode css-mode json-mode html-mode yaml-mode))

(set-formatter! 'headwind-rustywind "rustywind --stdin")

(setq-hook! '(js-mode-hook typescript-mode-hook css-mode-hook json-mode-hook html-mode-hook yaml-mode-hook) +format-with 'prettier-with-npx)
#+end_src
