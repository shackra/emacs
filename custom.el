...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (prodigy pydoc-info sphinx-doc tide expand-region font-lock-studio gherkin-mode webpaste highlight-indent-guides el-pocket twittering-mode better-defaults use-package org)))
